...
# <------Rotate button------>
btnRotate = Button(mains, text='Rotate', width=25, command=rotate, bg="#116A7B")
...
# <------Change image button------>
btnChaImg = Button(mains, text='Change Image', width=25,command=ChangeImg,bg="#967E76",activebackground="ORANGE")
btnChaImg.configure(font=('consolas',10,'bold'),foreground='white')
btnChaImg.place(x=805,y=35)
#btnChaImg.grid(row=0, column=1)

# <------Flip button------>
btnFlip = Button(mains, text='Flip', width=25, command=flip, bg="#F2BED1")
btnFlip.configure(font=('consolas',10,'bold'),foreground='BLACK')
btnFlip.place(x=805,y=180)
#btnFlip.grid(row=2, column=1)

# <------Resize button------>
btnResize = Button(mains, text='Resize', width=25, command=resize, bg="#98EECC")
btnResize.configure(font=('consolas',10,'bold'),foreground='black')
btnResize.place(x=805,y=255)
#btnResize.grid(row=3, column=1)

# <------Crop button------>
btnCrop = Button(mains, text='Crop', width=25, command=crop, bg="#1B9C85")
btnCrop.configure(font=('consolas',10,'bold'),foreground='black')
btnCrop.place(x=805,y=340)
#btnCrop.grid(row=4, column=1)

# <------Blur effect button------>
btnBlur = Button(mains, text='Blur', width=25, command=blurr, bg="#E4A5FF")
...
btnEmboss = Button(mains, text='Emboss', width=25, command=emboss, bg="#FEA1A1")
...
btnEdgeEnhance = Button(mains, text='EdgeEnhance', width=25, command=edgeEnhance, bg="#C1D0B5")
...
# <------Save button------>
btnSave = Button(mains, text='Save', width=25, command=save, bg="#654E92")
